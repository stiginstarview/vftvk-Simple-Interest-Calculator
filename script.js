function compute() {
    ...
    document.getElementById("result").innerHTML= "if you deposit <b>"+principal+"</b>,<br\><br\>at an interest rate of <b>" +rate+"</b>,<br\><br\>You will receive an amount of <b>"+interest+"</b>,<br\><br\>in the year <b>"+year+"</b>";
